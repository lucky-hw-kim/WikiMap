...
const addPin = (pinDetails) => {
  const { map_id, pin_icon_id, name, description, location, locked} = pinDetails;
  const queryString = `
  INSERT INTO pins (map_id, name, description, location, locked)
  VALUES ($1, $2, $3, $4, , $5)
  RETURNING *;
  `
  const queryParams = [map_id, name, description, location, locked];
