...
const addPin = (pinDetails) => {
  const { map_id, user_id, name, description, header_image, public} = pinDetails;
  const queryString = `
  INSERT INTO pins (map_id, user_id, name, description, header_image, date_created, date_modified, public)
  VALUES ($1, $2, $3, $4, $5, NOW(), NOW(), $6)
  RETURNING *;
  `
  const queryParams = [map_id, user_id, name, description, header_image, public];
